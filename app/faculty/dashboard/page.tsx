...
import {
    ...
    upsertFacultyMarks, publishFacultyMarks, getStudentMarksForCourse, CourseData, MarksData, getAllStudents, registerStudentForCourse
} from '@/lib/firebase';
...
const AddCourseForm = ({ facultyProfile, onCourseAdded }: { facultyProfile: DocumentData, onCourseAdded: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        if (!courseName || !courseCode || !academicYear) {
        ...
        try {
            ...
            // setAcademicYear(''); // Or keep for next entry
